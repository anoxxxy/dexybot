...
xybot.init = function() {
  ...
  //console.log(groupedMarketPairs);
                        ...
                        <div>
                          ...
                          <div for="data.market">
                            <div>
                              ...
                              <p>Volume (A): {{ data.volumea }}</p>
                              <p>Volume (B): {{ data.volumeb }}</p>
                              <p>Volume (USD): {{ data.volusd }}</p>
                            </div>
                          </div>
                          </div>
                        </div>`;

                        const tweets = `<div for="data.tweets">
  <div>
    <h1>{{ data.title }}</h1>
...
console.log('dataS: ', tweetsData);
xybot.view.viewMarketsTable.sync();
xybot.view.viewMarketsTable.render(dataS);
