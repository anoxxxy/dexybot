$(function() {
  ...
  //set mainnet or testnet for the exchange
  let exchangeUrl = xybot.api.testnet;
  ...
  xybot.vars.assetInfo = [
    ...
    { name: "Ethereum", ticker: "ETH", icon: "ethereum-eth-logo.svg", slug: ["eth", "teth", "teth1", "teth2", "teth3", "goerli", "rinkeby"] },
    { name: "BlackCoin", ticker: "BLK", icon: "blackcoin-blk-logo.svg", slug: ["blk", "tblk"] },
    { name: "Dai", ticker: "DAI", icon: "dai-dai-logo.svg", slug: ["dai", "tdai2", "tdai3"] },
  ];
...
xybot.update_markettrades = function (market, tradesupdatepage) {
  //console.log('xybot.update_markettrades'); //iceee commented out
