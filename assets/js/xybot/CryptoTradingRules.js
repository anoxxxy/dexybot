...
class CryptoTradingRules {
  ...
  const tradingRules = new CryptoTradingRules();

   console.log("\n=== BAY/DAI Market Making with Push Limits (Absolute) ===");
  var bayDaiRules = tradingRules.generateMarketMakingRules(1.1, {
  ...
  const randomBidPrice = tradingRules.getRandomTickPrice(bayDaiRules.bidTickPrices);
	console.log('Random bid price:', randomBidPrice);
